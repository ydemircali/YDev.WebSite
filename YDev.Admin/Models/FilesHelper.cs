...
namespace YDev.Admin.Models
{
    ...
    {
        private const string TEMP_PATH = @"images";
        private const string FILE_DIR_PATH = @"Upload\images";
        private const string URL_BASE = "/Upload/images/";
        ...
        public string CheckThumb(string type, string FileName)
        {
            ...
            if (splited.Length == 2)
            {
                ...
                else
                {
                    ...
                    if (extansion.Contains("mp4") || extansion.Contains("mpeg"))
                    {
                        return "/assets/global/img/video-play.png";
                    }
